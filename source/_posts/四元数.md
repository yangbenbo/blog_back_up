...
- 旋转公式
    ...
    其中$q=[\cos(\frac{\theta}{2}), \frac{\sin(\theta)}{2}\bold u]$,表示把$v$绕着$\bold u$旋转$\theta$得到$v'$
...
# 对偶四元数
[Dual_quaternion](https://en.wikipedia.org/wiki/Dual_quaternion)
[四元数学习笔记（二）：对偶四元数](https://blog.csdn.net/qq_45006390/article/details/128776069https://blog.csdn.net/qq_45006390/article/details/128776069)
[B. Kenwright, “A Beginners Guide to Dual-Quaternions”](http://wscg.zcu.cz/wscg2012/short/a29-full.pdf)
